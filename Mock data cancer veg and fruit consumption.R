...
g <- read.csv(file = "C:/Users/tamci/OneDrive/Desktop/cancer-data-for-MOOC-1-_1_.csv", 
...
# To display a summary of the ages of patients: 

summary(g$age) 



# To display a summary of the genders of patients: 

table(g$gender) 



# To display a summary of the BMI of patients: 

summary(g$bmi) 



# To display a summary of the smoking status of patients: 

table(g$smoking)

# To display a summary of the exercise status of patients: 

table(g$exercise) 


# To display a summary of the daily fruit consumption of patients: 

table(g$fruit) 


# To display a summary of the daily vegetable consumption of patients: 

table(g$veg) 


# To display a summary of the cancer status of patients: 
...
# To display a summary of the combined fruit and veg consumption of patients: 
...
# To display a histogram of the daily fruit and veg consumption of patients, including a title and proper axes: 
